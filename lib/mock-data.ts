export const kpis = [
  { label: "Energy Consumption", value: "14.2 GWh", delta: "-12% vs baseline" },
  { label: "CO2 Emissions", value: "3,240 tCO2e", delta: "-18% potential" },
  { label: "Portfolio ROI", value: "19.8%", delta: "+3.1 pts" },
  { label: "Annual Savings", value: "€1.24M", delta: "2030 projection" }
];
