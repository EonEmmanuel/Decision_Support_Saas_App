        ...
        <div className="h-72">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={energyTrend}>
              ...
              <YAxis stroke="#94a3b8" />
              <Tooltip />
              <Area type="monotone" dataKey="energy" stroke="#22d3ee" fill="#22d3ee33" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </Card>
        ...
        <div className="h-72">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={energyTrend}>
              ...
              <YAxis stroke="#94a3b8" />
              <Tooltip />
              <Line type="monotone" dataKey="co2" stroke="#34d399" strokeWidth={2} />
            </LineChart>
          </ResponsiveContainer>
        </div>
      </Card>
        ...
        <div className="h-72">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={energyTrend}>
              ...
              <YAxis stroke="#94a3b8" />
              <Tooltip />
              <Bar dataKey="capex" fill="#818cf8" />
              <Bar dataKey="roi" fill="#22d3ee" />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </Card>
